...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container-fluid">
    <!-- Navbar brand -->
    <a class="navbar-brand" href="#"><img src="<?php echo e(asset('img/LOGO_BTLECOUEST.png')); ?>"></a>
  ...
  <!-- MENU DROITE -->
      ...
      <li class="nav-item dropdown text-center mx-2 mx-lg-1">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-mdb-toggle="dropdown"
            aria-expanded="false">
            <div>
            <img src="<?php echo e(Auth::user()->avatar); ?>"alt="mdo" width="32" height="32" class="rounded-circle">
              <span class="badge rounded-pill badge-notification bg-primary"></span>
            </div>
