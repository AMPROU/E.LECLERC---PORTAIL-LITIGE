      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="dropdown text-end">
          <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="<?php echo e(Auth::user()->avatar); ?>"alt="mdo" width="32" height="32" class="rounded-circle"> <?php echo e(Auth::user()->name); ?> : <?php echo e($magasin->nom_magasin); ?>
...
</html><?php /**PATH /var/www/demeter.ovh/BtlecouestLaravel/resources/views/layouts/app.blade.php ENDPATH**/ ?>